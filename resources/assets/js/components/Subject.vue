        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                ...
                <div class="form-group">
                    ...
                    <input id="srname" type="text" class="form-control" name="srname" v-model="srname">
                </div>

                <div class="form-group">
                    <label for="date" class="col-form-label">DOB</label>
                        <input class="form-control" type="date" id="date" v-model="dob">
                </div>

                <div class="mb-2">
                    <p class="mb-2">Pol</p>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input v-model="pol" class="custom-control-input" type="radio" id="muski" value="m">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input v-model="pol" class="custom-control-input" type="radio" id="zenski" value="z">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="komentar" rows="3" v-model="komentar"></textarea>
                </div>
                    ...
                    <div class="row" v-for="studija in studije" :key="studija.id">
                        <div class="col-md-6 mb-4">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" :id=studija.id v-model="checked[studija.id]">
                            ...
                            <div class="card" v-if="checked[studija.id]" style="width: 18rem;">
                                <ul v-for="s in studija.groups" :key=s.id class="list-group list-group-flush">
                                    <li class="list-group-item" >
                                        ...
                                        <input  class="form-check-input"  type="radio" :value=s.id v-model="selected[s.study_id]" :id=s.id+studija.name>   
